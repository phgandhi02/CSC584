...
void Boid::update(){
    switch (m_spriteState){
        ...
        m_sprite.move(sf::Vector2f(0.f, m_speed));
            ...
            break;
        case 1:
            if (m_sprite.getPosition().x >= 640 and m_sprite.getPosition().y >= 480 and m_spriteState == 1){
        ...
        m_sprite.move(sf::Vector2f(0.f, m_speed));
            ...
            break;
        case 2:
            if (m_sprite.getPosition().x <= 0 and m_sprite.getPosition().y >= 480 and m_spriteState == 2){
        ...
        m_sprite.move(sf::Vector2f(-m_speed, 0.f));
            ...
            break;
        case 3:
            if (m_sprite.getPosition().x <= 0 and m_sprite.getPosition().y <= 0 and m_spriteState == 3){
